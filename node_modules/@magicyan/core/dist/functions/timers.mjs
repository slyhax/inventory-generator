...
const sleep = Object.assign(setTimeout$1, {
  seconds: (time) => setTimeout$1(time * 1e3),
  minutes: (time) => setTimeout$1(time * 1e3 * 60)
});
...
export { createInterval, createLoopInterval, createTimeout, sleep };
